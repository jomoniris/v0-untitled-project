...
export default async function EditRentalRatePage({
  params,
}: {
  params: PageParams
}) {
  // In Next.js App Router, we need to ensure params is properly handled
  // We'll use a try/catch to handle any potential errors
  try {
    ...
    console.error("Error in EditRentalRatePage:", error)
    return (
      <div className="container mx-auto py-10">
